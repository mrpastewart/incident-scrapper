...
$page = ereg_replace(".*scription</th></tr>", "", $page);
...
foreach ($lines as $line) {
	...
	$line = ereg_replace(".*style=.border-bottom: 1px solid #999999;padding: 0px 0px 0px 0px;.>", "", $line);
	$line = ereg_replace("</td><td align=.left. style=.*solid #999999;padding: 0px 6px 0px 0px;.>", "COLSEP", $line);
	$line = ereg_replace("</a></td><td align=.left. style=.border-bottom: 1px solid.* 0px 12px 0px 0px.*", "", $line);
	$line = ereg_replace("</td><td align=.left. style=.border-bottom: 1px solid.*.>", "COLSEP", $line);

	$line = html_entity_decode($line);

	$line = ereg_replace(" +", " ", $line);

	list($f1, $f2, $f3, $f4, $f5, $f6, $f7) = split("COLSEP", $line);
