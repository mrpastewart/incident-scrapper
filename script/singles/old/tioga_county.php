...
$table = "tioga_county";
$url = "http://216.37.214.105/PublicWebCAD/Summary.aspx";
$email_url = "http://216.37.214.105/PublicWebCAD/";
$agency = "Tioga County, Pennsylvania";
...
$page = ereg_replace(".*>Community</th>", "", $page);
