...
$table = "salisbury";
$url = "http://salisburyfd.com/runlog.cfm";
$email_url = $url;
$agency_name = "Salisbury, Maryland";
...
foreach ($lines as $line) {
	...
	if (ereg("<dt>City:</dt>|<dt>Address:</dt>", $line) && $ctr == 3) {
		$ctr++;
		continue;
	}

	if (ereg("<dd><address>", $line) && $ctr == 5) {
		$ctr = 4;
	}
